...
do {
opcion = await question(colors("Vamos, Elige alguna opcion:\n") + qrOption("1. Codigo QR\n") + textOption("2. Código de Verificacion\n--> "))
if (!/^[1-2]$/.test(opcion)) {
console.log(chalk.bold.redBright(`Bro solo elige 1 o 2 y listo ya me puedes usar.`))
